# Codex Qa Simplicity Check Mode
...
2. Read `roles/units/qa/simplicity-check.md` for the portable mode contract.
3. Run `adapters/codex/bin/preflight.sh mode-info qa/simplicity-check`.
...
- Treat `adapters/codex/modes/qa/simplicity-check.md` as the adapter-owned mode guide for this runtime.

## Projected Portable Mode Contract

The following contract is projected from `roles/units/qa/simplicity-check.md` with non-Codex runtime
