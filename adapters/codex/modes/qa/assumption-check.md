# Codex Qa Assumption Check Mode
...
2. Read `roles/units/qa/assumption-check.md` for the portable mode contract.
3. Run `adapters/codex/bin/preflight.sh mode-info qa/assumption-check`.
...
- Treat `adapters/codex/modes/qa/assumption-check.md` as the adapter-owned mode guide for this runtime.

## Projected Portable Mode Contract

The following contract is projected from `roles/units/qa/assumption-check.md` with non-Codex runtime
